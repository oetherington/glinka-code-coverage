...
{"lineNum":"   64","line":"    }"},
{"lineNum":"   65","line":""},
{"lineNum":"   66","line":"    pub fn getAllocator(self: *TsParser) Allocator {","class":"lineCov","hits":"1","order":"2709","possible_hits":"1",},
{"lineNum":"   67","line":"        return self.arena.allocator();","class":"lineCov","hits":"1","order":"2710","possible_hits":"1",},
{"lineNum":"   68","line":"    }"},
{"lineNum":"   69","line":""},
{"lineNum":"   70","line":"    pub fn getParser(self: *TsParser) *Parser {","class":"lineCov","hits":"1","order":"2663","possible_hits":"1",},
{"lineNum":"   71","line":"        return &self.parser;","class":"lineCov","hits":"1","order":"2664","possible_hits":"1",},
{"lineNum":"   72","line":"    }"},
{"lineNum":"   73","line":""},
...
{"lineNum":"   77","line":"    }"},
{"lineNum":"   78","line":""},
{"lineNum":"   79","line":"    pub fn parseExpr(self: *TsParser) ParseResult {","class":"lineCov","hits":"1","order":"2688","possible_hits":"1",},
{"lineNum":"   80","line":"        return exprParser.parseExpr(self.getParser());","class":"lineCov","hits":"1","order":"2689","possible_hits":"1",},
{"lineNum":"   81","line":"    }"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"    pub fn parseType(self: *TsParser) ParseResult {","class":"lineCov","hits":"1","order":"2894","possible_hits":"1",},
{"lineNum":"   84","line":"        return typeParser.parseType(self.getParser());","class":"lineCov","hits":"1","order":"2895","possible_hits":"1",},
{"lineNum":"   85","line":"    }"},
{"lineNum":"   86","line":""},
{"lineNum":"   87","line":"    pub fn parseBlock(self: *TsParser) ParseResult {","class":"lineCov","hits":"1","order":"2935","possible_hits":"1",},
{"lineNum":"   88","line":"        return stmtParser.parseBlock(self.getParser());","class":"lineCov","hits":"1","order":"2936","possible_hits":"1",},
{"lineNum":"   89","line":"    }"},
{"lineNum":"   90","line":""},
{"lineNum":"   91","line":"    pub fn parseStmt(self: *TsParser) ParseResult {","class":"lineCov","hits":"1","order":"3560","possible_hits":"1",},
{"lineNum":"   92","line":"        return stmtParser.parseStmt(self.getParser());","class":"lineCov","hits":"1","order":"3561","possible_hits":"1",},
{"lineNum":"   93","line":"    }"},
{"lineNum":"   94","line":""},
...
var header = { "command" : "test", "date" : "2022-01-10 07:49:02", "instrumented" : 31, "covered" : 28,};
var merged_data = [];
