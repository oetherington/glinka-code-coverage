...
{"lineNum":"  135","line":"    }"},
{"lineNum":"  136","line":""},
{"lineNum":"  137","line":"    pub fn fmt(","class":"linePartCov","hits":"9","order":"3516","possible_hits":"20",},
{"lineNum":"  138","line":"        self: *Compiler,"},
{"lineNum":"  139","line":"        comptime format: []const u8,"},
{"lineNum":"  140","line":"        args: anytype,"},
{"lineNum":"  141","line":"    ) []u8 {"},
{"lineNum":"  142","line":"        const string = std.fmt.allocPrint(","class":"linePartCov","hits":"9","order":"3519","possible_hits":"20",},
{"lineNum":"  143","line":"            self.alloc,","class":"linePartCov","hits":"9","order":"3517","possible_hits":"20",},
{"lineNum":"  144","line":"            format,"},
{"lineNum":"  145","line":"            args,","class":"linePartCov","hits":"9","order":"3518","possible_hits":"19",},
{"lineNum":"  146","line":"        ) catch allocate.reportAndExit();","class":"linePartCov","hits":"9","order":"3520","possible_hits":"20",},
{"lineNum":"  147","line":"        self.strings.append(string) catch allocate.reportAndExit();","class":"linePartCov","hits":"9","order":"3521","possible_hits":"20",},
{"lineNum":"  148","line":"        return string;","class":"linePartCov","hits":"9","order":"3522","possible_hits":"20",},
{"lineNum":"  149","line":"    }"},
{"lineNum":"  150","line":""},
{"lineNum":"  151","line":"    pub fn implicitAny(","class":"lineCov","hits":"1","order":"5270","possible_hits":"1",},
{"lineNum":"  152","line":"        self: *Compiler,"},
{"lineNum":"  153","line":"        csr: Cursor,"},
{"lineNum":"  154","line":"        symbol: []const u8,"},
{"lineNum":"  155","line":"    ) Type.Ptr {"},
{"lineNum":"  156","line":"        if (self.config.errorOnImplicitAny)","class":"lineCov","hits":"2","order":"5271","possible_hits":"2",},
{"lineNum":"  157","line":"            self.errors.append(CompileError.implicitAnyError(","class":"lineCov","hits":"2","order":"5272","possible_hits":"2",},
{"lineNum":"  158","line":"                ImplicitAnyError.new(csr, symbol),","class":"lineCov","hits":"1","order":"5273","possible_hits":"1",},
{"lineNum":"  159","line":"            )) catch allocate.reportAndExit();","class":"lineCov","hits":"1","order":"5274","possible_hits":"1",},
{"lineNum":"  160","line":""},
{"lineNum":"  161","line":"        return self.typebook.getAny();","class":"lineCov","hits":"1","order":"5275","possible_hits":"1",},
{"lineNum":"  162","line":"    }"},
{"lineNum":"  163","line":""},
...
{"lineNum":"  170","line":"            },"},
{"lineNum":"  171","line":"            .Error => |err| {","class":"lineCov","hits":"1","order":"5119","possible_hits":"1",},
{"lineNum":"  172","line":"                self.errors.append(err) catch allocate.reportAndExit();","class":"lineCov","hits":"1","order":"5120","possible_hits":"1",},
{"lineNum":"  173","line":"                return null;","class":"lineCov","hits":"1","order":"5121","possible_hits":"1",},
{"lineNum":"  174","line":"            },"},
{"lineNum":"  175","line":"        }"},
{"lineNum":"  176","line":"    }"},
{"lineNum":"  177","line":""},
...
{"lineNum":"  197","line":"            .Block => block.processBlock(self, nd),","class":"lineCov","hits":"1","order":"5238","possible_hits":"1",},
{"lineNum":"  198","line":"            .Decl => declaration.processDecl(self, nd),","class":"lineCov","hits":"1","order":"3277","possible_hits":"1",},
{"lineNum":"  199","line":"            .If => conditional.processConditional(self, nd),","class":"lineCov","hits":"1","order":"5352","possible_hits":"1",},
{"lineNum":"  200","line":"            .Switch => conditional.processSwitch(self, nd),","class":"lineCov","hits":"1","order":"5376","possible_hits":"1",},
{"lineNum":"  201","line":"            .For => loop.processFor(self, nd),","class":"lineCov","hits":"1","order":"5404","possible_hits":"1",},
{"lineNum":"  202","line":"            .While => loop.processWhile(self, nd),","class":"lineCov","hits":"1","order":"5230","possible_hits":"1",},
{"lineNum":"  203","line":"            .Do => loop.processDo(self, nd),","class":"lineCov","hits":"1","order":"5425","possible_hits":"1",},
{"lineNum":"  204","line":"            .Break => loop.processBreak(self, nd),","class":"lineCov","hits":"1","order":"5389","possible_hits":"1",},
{"lineNum":"  205","line":"            .Continue => loop.processContinue(self, nd),","class":"lineCov","hits":"1","order":"5454","possible_hits":"1",},
{"lineNum":"  206","line":"            .Throw => throw.processThrow(self, nd),","class":"lineCov","hits":"1","order":"5476","possible_hits":"1",},
{"lineNum":"  207","line":"            .Try => throw.processTry(self, nd),","class":"lineCov","hits":"1","order":"5483","possible_hits":"1",},
{"lineNum":"  208","line":"            .Function => function.processFunction(self, nd),","class":"lineCov","hits":"1","order":"5507","possible_hits":"1",},
{"lineNum":"  209","line":"            .Return => function.processReturn(self, nd),","class":"lineCov","hits":"1","order":"5396","possible_hits":"1",},
...
var header = { "command" : "test", "date" : "2022-02-13 12:34:35", "instrumented" : 133, "covered" : 120,};
var merged_data = [];
