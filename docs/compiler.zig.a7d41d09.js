...
{"lineNum":"   84","line":"            self.alloc.free(string);","class":"lineCov","hits":"1","order":"4651","possible_hits":"1",},
{"lineNum":"   85","line":""},
...
{"lineNum":"   98","line":"    }"},
{"lineNum":"   99","line":""},
{"lineNum":"  100","line":"    pub fn hasErrors(self: Compiler) bool {","class":"lineCov","hits":"1","order":"4182","possible_hits":"1",},
{"lineNum":"  101","line":"        return self.errors.count() > 0;","class":"lineCov","hits":"1","order":"4183","possible_hits":"1",},
{"lineNum":"  102","line":"    }"},
{"lineNum":"  103","line":""},
...
{"lineNum":"  106","line":"    }"},
{"lineNum":"  107","line":""},
{"lineNum":"  108","line":"    pub fn getError(self: Compiler, index: usize) CompileError {","class":"lineCov","hits":"1","order":"4225","possible_hits":"1",},
{"lineNum":"  109","line":"        return self.errors.list.items[index];","class":"lineCov","hits":"1","order":"4226","possible_hits":"1",},
{"lineNum":"  110","line":"    }"},
{"lineNum":"  111","line":""},
{"lineNum":"  112","line":"    pub fn fmt(","class":"linePartCov","hits":"5","order":"4632","possible_hits":"8",},
{"lineNum":"  113","line":"        self: *Compiler,"},
{"lineNum":"  114","line":"        comptime format: []const u8,"},
{"lineNum":"  115","line":"        args: anytype,"},
{"lineNum":"  116","line":"    ) []u8 {"},
{"lineNum":"  117","line":"        const string = std.fmt.allocPrint(","class":"linePartCov","hits":"5","order":"4635","possible_hits":"8",},
{"lineNum":"  118","line":"            self.alloc,","class":"linePartCov","hits":"5","order":"4633","possible_hits":"8",},
{"lineNum":"  119","line":"            format,"},
{"lineNum":"  120","line":"            args,","class":"linePartCov","hits":"5","order":"4634","possible_hits":"8",},
{"lineNum":"  121","line":"        ) catch allocate.reportAndExit();","class":"linePartCov","hits":"5","order":"4636","possible_hits":"8",},
{"lineNum":"  122","line":"        self.strings.append(string) catch allocate.reportAndExit();","class":"linePartCov","hits":"5","order":"4637","possible_hits":"8",},
{"lineNum":"  123","line":"        return string;","class":"linePartCov","hits":"5","order":"4638","possible_hits":"8",},
{"lineNum":"  124","line":"    }"},
{"lineNum":"  125","line":""},
{"lineNum":"  126","line":"    pub fn implicitAny(","class":"lineCov","hits":"1","order":"4360","possible_hits":"1",},
{"lineNum":"  127","line":"        self: *Compiler,"},
{"lineNum":"  128","line":"        csr: Cursor,"},
{"lineNum":"  129","line":"        symbol: []const u8,"},
{"lineNum":"  130","line":"    ) Type.Ptr {"},
{"lineNum":"  131","line":"        if (self.config.errorOnImplicitAny)","class":"lineCov","hits":"2","order":"4361","possible_hits":"2",},
{"lineNum":"  132","line":"            self.errors.append(CompileError.implicitAnyError(","class":"lineCov","hits":"2","order":"4362","possible_hits":"2",},
{"lineNum":"  133","line":"                ImplicitAnyError.new(csr, symbol),","class":"lineCov","hits":"1","order":"4363","possible_hits":"1",},
{"lineNum":"  134","line":"            )) catch allocate.reportAndExit();","class":"lineCov","hits":"1","order":"4364","possible_hits":"1",},
{"lineNum":"  135","line":""},
{"lineNum":"  136","line":"        return self.typebook.getAny();","class":"lineCov","hits":"1","order":"4365","possible_hits":"1",},
{"lineNum":"  137","line":"    }"},
{"lineNum":"  138","line":""},
{"lineNum":"  139","line":"    pub fn inferExprType(self: *Compiler, nd: Node) ?Type.Ptr {","class":"lineCov","hits":"1","order":"4165","possible_hits":"1",},
{"lineNum":"  140","line":"        const valTy = inferrer.inferExprType(self, nd);","class":"lineCov","hits":"1","order":"4166","possible_hits":"1",},
{"lineNum":"  141","line":"        switch (valTy) {","class":"linePartCov","hits":"1","order":"4174","possible_hits":"2",},
{"lineNum":"  142","line":"            .Success => |ty| {","class":"lineCov","hits":"1","order":"4175","possible_hits":"1",},
{"lineNum":"  143","line":"                nd.ty = ty;","class":"lineCov","hits":"1","order":"4176","possible_hits":"1",},
{"lineNum":"  144","line":"                return ty;","class":"lineCov","hits":"1","order":"4177","possible_hits":"1",},
{"lineNum":"  145","line":"            },"},
{"lineNum":"  146","line":"            .Error => |err| {","class":"lineCov","hits":"1","order":"4219","possible_hits":"1",},
{"lineNum":"  147","line":"                self.errors.append(err) catch allocate.reportAndExit();","class":"lineCov","hits":"1","order":"4220","possible_hits":"1",},
{"lineNum":"  148","line":"                return null;","class":"lineCov","hits":"1","order":"4221","possible_hits":"1",},
{"lineNum":"  149","line":"            },"},
{"lineNum":"  150","line":"        }"},
{"lineNum":"  151","line":"    }"},
{"lineNum":"  152","line":""},
{"lineNum":"  153","line":"    pub fn findType(self: *Compiler, nd: Node) ?Type.Ptr {","class":"lineCov","hits":"1","order":"4379","possible_hits":"1",},
{"lineNum":"  154","line":"        return typeFinder.findType(self.scope, self.typebook, nd);","class":"lineCov","hits":"1","order":"4380","possible_hits":"1",},
{"lineNum":"  155","line":"    }"},
{"lineNum":"  156","line":""},
{"lineNum":"  157","line":"    pub fn processNode(self: *Compiler, nd: Node) void {","class":"lineCov","hits":"2","order":"4153","possible_hits":"2",},
{"lineNum":"  158","line":"        switch (nd.data) {","class":"lineCov","hits":"15","order":"4154","possible_hits":"15",},
...
{"lineNum":"  171","line":"            => expression.processExpression(self, nd),","class":"lineCov","hits":"1","order":"4188","possible_hits":"1",},
{"lineNum":"  172","line":"            .Block => block.processBlock(self, nd),","class":"lineCov","hits":"1","order":"4325","possible_hits":"1",},
{"lineNum":"  173","line":"            .Decl => declaration.processDecl(self, nd),","class":"lineCov","hits":"1","order":"4155","possible_hits":"1",},
{"lineNum":"  174","line":"            .If => conditional.processConditional(self, nd),","class":"lineCov","hits":"1","order":"4413","possible_hits":"1",},
{"lineNum":"  175","line":"            .Switch => conditional.processSwitch(self, nd),","class":"lineCov","hits":"1","order":"4437","possible_hits":"1",},
{"lineNum":"  176","line":"            .For => loop.processFor(self, nd),","class":"lineCov","hits":"1","order":"4465","possible_hits":"1",},
{"lineNum":"  177","line":"            .While => loop.processWhile(self, nd),","class":"lineCov","hits":"1","order":"4317","possible_hits":"1",},
{"lineNum":"  178","line":"            .Do => loop.processDo(self, nd),","class":"lineCov","hits":"1","order":"4486","possible_hits":"1",},
{"lineNum":"  179","line":"            .Break => loop.processBreak(self, nd),","class":"lineCov","hits":"1","order":"4450","possible_hits":"1",},
{"lineNum":"  180","line":"            .Continue => loop.processContinue(self, nd),","class":"lineCov","hits":"1","order":"4515","possible_hits":"1",},
{"lineNum":"  181","line":"            .Throw => throw.processThrow(self, nd),","class":"lineCov","hits":"1","order":"4537","possible_hits":"1",},
{"lineNum":"  182","line":"            .Try => throw.processTry(self, nd),","class":"lineCov","hits":"1","order":"4544","possible_hits":"1",},
{"lineNum":"  183","line":"            .Function => function.processFunction(self, nd),","class":"lineCov","hits":"1","order":"4568","possible_hits":"1",},
{"lineNum":"  184","line":"            .Return => function.processReturn(self, nd),","class":"lineCov","hits":"1","order":"4457","possible_hits":"1",},
{"lineNum":"  185","line":"            .Alias => types.processAlias(self, nd),","class":"lineCov","hits":"1","order":"4729","possible_hits":"1",},
...
{"lineNum":"  191","line":"    }"},
{"lineNum":"  192","line":""},
{"lineNum":"  193","line":"    pub fn compileProgramNode(self: *Compiler, nd: Node) !void {","class":"lineCov","hits":"2","order":"4147","possible_hits":"2",},
{"lineNum":"  194","line":"        std.debug.assert(nd.getType() == .Program);","class":"lineCov","hits":"1","order":"4148","possible_hits":"1",},
{"lineNum":"  195","line":""},
{"lineNum":"  196","line":"        try self.backend.prolog();","class":"lineCov","hits":"1","order":"4149","possible_hits":"1",},
{"lineNum":"  197","line":""},
{"lineNum":"  198","line":"        for (nd.data.Program.items) |child| {","class":"lineCov","hits":"3","order":"4151","possible_hits":"3",},
{"lineNum":"  199","line":"            self.processNode(child);","class":"lineCov","hits":"1","order":"4152","possible_hits":"1",},
{"lineNum":"  200","line":"            if (!self.hasErrors())","class":"lineCov","hits":"2","order":"4181","possible_hits":"2",},
{"lineNum":"  201","line":"                try self.backend.processNode(child);","class":"lineCov","hits":"1","order":"4184","possible_hits":"1",},
{"lineNum":"  202","line":"        }"},
{"lineNum":"  203","line":""},
{"lineNum":"  204","line":"        try self.backend.epilog();","class":"lineCov","hits":"1","order":"4202","possible_hits":"1",},
{"lineNum":"  205","line":"    }"},
{"lineNum":"  206","line":""},
...
var header = { "command" : "test", "date" : "2022-01-10 07:49:02", "instrumented" : 104, "covered" : 91,};
var merged_data = [];
