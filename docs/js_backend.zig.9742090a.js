...
{"lineNum":"   81","line":"    }"},
{"lineNum":"   82","line":""},
{"lineNum":"   83","line":"    fn processNode(be: *Backend, nd: Node) Backend.Error!void {","class":"lineCov","hits":"2","order":"5040","possible_hits":"2",},
{"lineNum":"   84","line":"        const self = JsBackend.getSelf(be);","class":"lineCov","hits":"1","order":"5041","possible_hits":"1",},
{"lineNum":"   85","line":"        try self.emitNode(nd);","class":"lineCov","hits":"1","order":"5042","possible_hits":"1",},
{"lineNum":"   86","line":"    }"},
{"lineNum":"   87","line":""},
{"lineNum":"   88","line":"    pub fn emitExpr(self: JsBackend, value: Node) Backend.Error!void {","class":"lineCov","hits":"1","order":"5065","possible_hits":"1",},
{"lineNum":"   89","line":"        return try exprEmitter.emitExpr(self, value);","class":"lineCov","hits":"1","order":"5066","possible_hits":"1",},
{"lineNum":"   90","line":"    }"},
{"lineNum":"   91","line":""},
{"lineNum":"   92","line":"    pub fn emitNode(self: *JsBackend, nd: Node) Backend.Error!void {","class":"lineCov","hits":"2","order":"5043","possible_hits":"2",},
{"lineNum":"   93","line":"        switch (nd.data) {","class":"lineCov","hits":"2","order":"5044","possible_hits":"2",},
...
{"lineNum":"  111","line":"            => {"},
{"lineNum":"  112","line":"                try self.emitExpr(nd);","class":"lineCov","hits":"1","order":"5064","possible_hits":"1",},
{"lineNum":"  113","line":"                try self.out.print(\";\\n\", .{});","class":"lineCov","hits":"1","order":"5070","possible_hits":"1",},
{"lineNum":"  114","line":"            },"},
{"lineNum":"  115","line":"            .Block => try blockEmitter.emitBlock(self, nd.data.Block.items),","class":"lineCov","hits":"2","order":"5045","possible_hits":"2",},
{"lineNum":"  116","line":"            .Decl => try declEmitter.emitDecl(self, nd.data.Decl),","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  117","line":"            .If => try condEmitter.emitCond(self, nd.data.If),","class":"lineCov","hits":"2","order":"5115","possible_hits":"2",},
{"lineNum":"  118","line":"            .Switch => try condEmitter.emitSwitch(self, nd.data.Switch),","class":"lineCov","hits":"2","order":"5214","possible_hits":"2",},
{"lineNum":"  119","line":"            .For => try loopEmitter.emitFor(self, nd.data.For),","class":"lineCov","hits":"2","order":"5260","possible_hits":"2",},
{"lineNum":"  120","line":"            .While => try loopEmitter.emitWhile(self, nd.data.While),","class":"lineCov","hits":"2","order":"5305","possible_hits":"2",},
{"lineNum":"  121","line":"            .Do => try loopEmitter.emitDo(self, nd.data.Do),","class":"lineCov","hits":"2","order":"5322","possible_hits":"2",},
{"lineNum":"  122","line":"            .Break => try loopEmitter.emitBreak(self, nd.data.Break),","class":"lineCov","hits":"2","order":"5230","possible_hits":"2",},
{"lineNum":"  123","line":"            .Continue => try loopEmitter.emitContinue(self, nd.data.Continue),","class":"lineCov","hits":"2","order":"5347","possible_hits":"2",},
{"lineNum":"  124","line":"            .Throw => try throwEmitter.emitThrow(self, nd.data.Throw),","class":"lineCov","hits":"2","order":"5363","possible_hits":"2",},
{"lineNum":"  125","line":"            .Try => try throwEmitter.emitTry(self, nd.data.Try),","class":"lineCov","hits":"2","order":"5386","possible_hits":"2",},
{"lineNum":"  126","line":"            .Function => try functionEmitter.emitFunc(self, nd.data.Function),","class":"lineCov","hits":"2","order":"5410","possible_hits":"2",},
{"lineNum":"  127","line":"            .Return => try functionEmitter.emitReturn(self, nd.data.Return),","class":"lineCov","hits":"2","order":"5226","possible_hits":"2",},
...
var header = { "command" : "test", "date" : "2022-01-12 21:56:54", "instrumented" : 60, "covered" : 57,};
var merged_data = [];
