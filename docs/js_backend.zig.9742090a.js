...
{"lineNum":"  112","line":"    }"},
{"lineNum":"  113","line":""},
{"lineNum":"  114","line":"    fn processNode(be: *Backend, nd: Node) Backend.Error!void {","class":"lineCov","hits":"2","order":"5708","possible_hits":"2",},
{"lineNum":"  115","line":"        const self = JsBackend.getSelf(be);","class":"lineCov","hits":"1","order":"5709","possible_hits":"1",},
{"lineNum":"  116","line":"        try self.emitNode(nd);","class":"lineCov","hits":"1","order":"5710","possible_hits":"1",},
{"lineNum":"  117","line":"    }"},
{"lineNum":"  118","line":""},
{"lineNum":"  119","line":"    pub fn emitExpr(self: JsBackend, value: Node) Backend.Error!void {","class":"lineCov","hits":"1","order":"5733","possible_hits":"1",},
{"lineNum":"  120","line":"        return try exprEmitter.emitExpr(self, value);","class":"lineCov","hits":"1","order":"5734","possible_hits":"1",},
{"lineNum":"  121","line":"    }"},
{"lineNum":"  122","line":""},
{"lineNum":"  123","line":"    pub fn emitNode(self: *JsBackend, nd: Node) Backend.Error!void {","class":"lineCov","hits":"2","order":"5711","possible_hits":"2",},
{"lineNum":"  124","line":"        switch (nd.data) {","class":"lineCov","hits":"2","order":"5712","possible_hits":"2",},
...
{"lineNum":"  143","line":"            => {"},
{"lineNum":"  144","line":"                try self.emitExpr(nd);","class":"lineCov","hits":"1","order":"5732","possible_hits":"1",},
{"lineNum":"  145","line":"                try self.out.print(\";\\n\", .{});","class":"lineCov","hits":"1","order":"5738","possible_hits":"1",},
{"lineNum":"  146","line":"            },"},
{"lineNum":"  147","line":"            .Block => try blockEmitter.emitBlock(self, nd.data.Block.items),","class":"lineCov","hits":"2","order":"5713","possible_hits":"2",},
{"lineNum":"  148","line":"            .Decl => try declEmitter.emitDecl(self, nd.data.Decl),","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  149","line":"            .If => try condEmitter.emitCond(self, nd.data.If),","class":"lineCov","hits":"2","order":"5783","possible_hits":"2",},
{"lineNum":"  150","line":"            .Switch => try condEmitter.emitSwitch(self, nd.data.Switch),","class":"lineCov","hits":"2","order":"5882","possible_hits":"2",},
{"lineNum":"  151","line":"            .For => try loopEmitter.emitFor(self, nd.data.For),","class":"lineCov","hits":"2","order":"5928","possible_hits":"2",},
{"lineNum":"  152","line":"            .While => try loopEmitter.emitWhile(self, nd.data.While),","class":"lineCov","hits":"2","order":"5973","possible_hits":"2",},
{"lineNum":"  153","line":"            .Do => try loopEmitter.emitDo(self, nd.data.Do),","class":"lineCov","hits":"2","order":"5990","possible_hits":"2",},
{"lineNum":"  154","line":"            .Break => try loopEmitter.emitBreak(self, nd.data.Break),","class":"lineCov","hits":"2","order":"5898","possible_hits":"2",},
{"lineNum":"  155","line":"            .Continue => try loopEmitter.emitContinue(self, nd.data.Continue),","class":"lineCov","hits":"2","order":"6015","possible_hits":"2",},
{"lineNum":"  156","line":"            .Throw => try throwEmitter.emitThrow(self, nd.data.Throw),","class":"lineCov","hits":"2","order":"6031","possible_hits":"2",},
{"lineNum":"  157","line":"            .Try => try throwEmitter.emitTry(self, nd.data.Try),","class":"lineCov","hits":"2","order":"6054","possible_hits":"2",},
{"lineNum":"  158","line":"            .Function => try functionEmitter.emitFunc(self, nd.data.Function),","class":"lineCov","hits":"2","order":"6078","possible_hits":"2",},
{"lineNum":"  159","line":"            .Return => try functionEmitter.emitReturn(self, nd.data.Return),","class":"lineCov","hits":"2","order":"5894","possible_hits":"2",},
{"lineNum":"  160","line":"            .Alias => {},"},
{"lineNum":"  161","line":"            .InterfaceType => {},"},
{"lineNum":"  162","line":"            .ClassType => try classEmitter.emitClass(self, nd.data.ClassType),","class":"lineCov","hits":"2","order":"6155","possible_hits":"2",},
...
var header = { "command" : "test", "date" : "2022-02-13 15:55:52", "instrumented" : 61, "covered" : 58,};
var merged_data = [];
