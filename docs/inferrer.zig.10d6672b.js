...
{"lineNum":"   59","line":"        .Float => inferPrimaryExprType(nd, cmp.typebook.getNumber()),","class":"lineCov","hits":"1","order":"6843","possible_hits":"1",},
{"lineNum":"   60","line":"        .String,"},
{"lineNum":"   61","line":"        .Template,"},
{"lineNum":"   62","line":"        => inferPrimaryExprType(nd, cmp.typebook.getString()),","class":"lineCov","hits":"1","order":"5167","possible_hits":"1",},
{"lineNum":"   63","line":"        .True,"},
{"lineNum":"   64","line":"        .False,"},
{"lineNum":"   65","line":"        => inferPrimaryExprType(nd, cmp.typebook.getBoolean()),","class":"lineCov","hits":"1","order":"5137","possible_hits":"1",},
{"lineNum":"   66","line":"        .Null => inferPrimaryExprType(nd, cmp.typebook.getNull()),","class":"lineCov","hits":"1","order":"5407","possible_hits":"1",},
{"lineNum":"   67","line":"        .Undefined => inferPrimaryExprType(nd, cmp.typebook.getUndefined()),","class":"lineCov","hits":"1","order":"5408","possible_hits":"1",},
...
{"lineNum":"   71","line":"        => |op| inferUnaryOpType(cmp, nd, ctx, op),","class":"lineCov","hits":"1","order":"5154","possible_hits":"1",},
{"lineNum":"   72","line":"        .BinaryOp => |op| inferBinaryOpType(cmp, nd, ctx, op),","class":"lineCov","hits":"1","order":"3646","possible_hits":"1",},
{"lineNum":"   73","line":"        .Ternary => |trn| inferTernaryType(cmp, nd, ctx, trn),","class":"lineCov","hits":"1","order":"5198","possible_hits":"1",},
{"lineNum":"   74","line":"        .Call => |call| inferCallType(cmp, nd, ctx, call),","class":"lineCov","hits":"1","order":"5222","possible_hits":"1",},
{"lineNum":"   75","line":"        .Array => |arr| inferArrayType(cmp, nd, ctx, arr),","class":"lineCov","hits":"1","order":"7050","possible_hits":"1",},
{"lineNum":"   76","line":"        .ArrayAccess => |access| inferArrayAccessType(cmp, nd, ctx, access),","class":"lineCov","hits":"1","order":"7116","possible_hits":"1",},
{"lineNum":"   77","line":"        .Dot => |dot| inferDotType(cmp, nd, ctx, dot),","class":"lineCov","hits":"1","order":"3650","possible_hits":"1",},
{"lineNum":"   78","line":"        .Object => |obj| inferObjectType(cmp, nd, ctx, obj),","class":"lineCov","hits":"1","order":"7193","possible_hits":"1",},
...
var header = { "command" : "test", "date" : "2022-02-13 15:59:30", "instrumented" : 20, "covered" : 18,};
var merged_data = [];
