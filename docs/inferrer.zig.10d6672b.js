...
{"lineNum":"   51","line":""},
{"lineNum":"   52","line":"pub fn inferExprType(","class":"lineCov","hits":"1","order":"3294","possible_hits":"1",},
{"lineNum":"   53","line":"    cmp: *Compiler,"},
{"lineNum":"   54","line":"    nd: Node,"},
{"lineNum":"   55","line":"    ctx: *const InferContext,"},
{"lineNum":"   56","line":") InferResult {"},
{"lineNum":"   57","line":"    return switch (nd.data) {","class":"lineCov","hits":"17","order":"3295","possible_hits":"17",},
{"lineNum":"   58","line":"        .Int => inferPrimaryExprType(nd, cmp.typebook.getNumber()),","class":"lineCov","hits":"1","order":"3296","possible_hits":"1",},
{"lineNum":"   59","line":"        .Float => inferPrimaryExprType(nd, cmp.typebook.getNumber()),","class":"lineCov","hits":"1","order":"6823","possible_hits":"1",},
{"lineNum":"   60","line":"        .String,"},
{"lineNum":"   61","line":"        .Template,"},
{"lineNum":"   62","line":"        => inferPrimaryExprType(nd, cmp.typebook.getString()),","class":"lineCov","hits":"1","order":"5149","possible_hits":"1",},
{"lineNum":"   63","line":"        .True,"},
{"lineNum":"   64","line":"        .False,"},
{"lineNum":"   65","line":"        => inferPrimaryExprType(nd, cmp.typebook.getBoolean()),","class":"lineCov","hits":"1","order":"5113","possible_hits":"1",},
{"lineNum":"   66","line":"        .Null => inferPrimaryExprType(nd, cmp.typebook.getNull()),","class":"lineCov","hits":"1","order":"5387","possible_hits":"1",},
{"lineNum":"   67","line":"        .Undefined => inferPrimaryExprType(nd, cmp.typebook.getUndefined()),","class":"lineCov","hits":"1","order":"5388","possible_hits":"1",},
{"lineNum":"   68","line":"        .Ident => |ident| inferIdentType(cmp, nd, ident),","class":"lineCov","hits":"1","order":"3630","possible_hits":"1",},
{"lineNum":"   69","line":"        .PrefixOp,"},
{"lineNum":"   70","line":"        .PostfixOp,"},
{"lineNum":"   71","line":"        => |op| inferUnaryOpType(cmp, nd, ctx, op),","class":"lineCov","hits":"1","order":"5136","possible_hits":"1",},
{"lineNum":"   72","line":"        .BinaryOp => |op| inferBinaryOpType(cmp, nd, ctx, op),","class":"lineCov","hits":"1","order":"3646","possible_hits":"1",},
{"lineNum":"   73","line":"        .Ternary => |trn| inferTernaryType(cmp, nd, ctx, trn),","class":"lineCov","hits":"1","order":"5180","possible_hits":"1",},
{"lineNum":"   74","line":"        .Call => |call| inferCallType(cmp, nd, ctx, call),","class":"lineCov","hits":"1","order":"5204","possible_hits":"1",},
{"lineNum":"   75","line":"        .Array => |arr| inferArrayType(cmp, nd, ctx, arr),","class":"lineCov","hits":"1","order":"7033","possible_hits":"1",},
{"lineNum":"   76","line":"        .ArrayAccess => |access| inferArrayAccessType(cmp, nd, ctx, access),","class":"lineCov","hits":"1","order":"7099","possible_hits":"1",},
{"lineNum":"   77","line":"        .Dot => |dot| inferDotType(cmp, nd, ctx, dot),","class":"lineCov","hits":"1","order":"3650","possible_hits":"1",},
{"lineNum":"   78","line":"        .Object => |obj| inferObjectType(cmp, nd, ctx, obj),","class":"lineCov","hits":"1","order":"7176","possible_hits":"1",},
{"lineNum":"   79","line":"        .New => |new| inferNewType(cmp, nd, ctx, new),","class":"lineCov","hits":"1","order":"3622","possible_hits":"1",},
...
var header = { "command" : "test", "date" : "2022-02-13 14:13:43", "instrumented" : 20, "covered" : 18,};
var merged_data = [];
