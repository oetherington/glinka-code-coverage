...
{"lineNum":"   32","line":""},
{"lineNum":"   33","line":"    pub fn new(cond: Node, body: Node) While {","class":"lineCov","hits":"1","order":"836","possible_hits":"1",},
{"lineNum":"   34","line":"        return While{","class":"lineCov","hits":"1","order":"839","possible_hits":"1",},
{"lineNum":"   35","line":"            .cond = cond,","class":"lineCov","hits":"1","order":"837","possible_hits":"1",},
{"lineNum":"   36","line":"            .body = body,","class":"lineCov","hits":"1","order":"838","possible_hits":"1",},
{"lineNum":"   37","line":"        };"},
{"lineNum":"   38","line":"    }"},
{"lineNum":"   39","line":""},
...
{"lineNum":"   51","line":"};"},
{"lineNum":"   52","line":""},
{"lineNum":"   53","line":"test \"can dump a While\" {","class":"lineCov","hits":"3","order":"832","possible_hits":"3",},
{"lineNum":"   54","line":"    const nodes = [_]Node{"},
{"lineNum":"   55","line":"        makeNode(std.testing.allocator, Cursor.new(1, 1), .Int, \"1\"),","class":"lineCov","hits":"1","order":"833","possible_hits":"1",},
{"lineNum":"   56","line":"        makeNode(std.testing.allocator, Cursor.new(2, 1), .Int, \"2\"),","class":"lineCov","hits":"1","order":"834","possible_hits":"1",},
{"lineNum":"   57","line":"    };"},
{"lineNum":"   58","line":""},
{"lineNum":"   59","line":"    defer for (nodes) |node|","class":"linePartCov","hits":"2","order":"851","possible_hits":"4",},
{"lineNum":"   60","line":"        std.testing.allocator.destroy(node);","class":"linePartCov","hits":"1","order":"852","possible_hits":"2",},
{"lineNum":"   61","line":""},
{"lineNum":"   62","line":"    try (DumpTestCase(While, .While){","class":"linePartCov","hits":"1","order":"850","possible_hits":"2",},
{"lineNum":"   63","line":"        .value = While.new(nodes[0], nodes[1]),","class":"lineCov","hits":"1","order":"835","possible_hits":"1",},
{"lineNum":"   64","line":"        .expected =","class":"lineCov","hits":"1","order":"840","possible_hits":"1",},
...
{"lineNum":"   72","line":"        \\\\"},
{"lineNum":"   73","line":"        ,"},
{"lineNum":"   74","line":"    }).run();","class":"lineCov","hits":"1","order":"841","possible_hits":"1",},
{"lineNum":"   75","line":"}"},
]};
