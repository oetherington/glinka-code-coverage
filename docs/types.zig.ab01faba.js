...
{"lineNum":"   27","line":""},
{"lineNum":"   28","line":"pub fn processAlias(cmp: *Compiler, nd: Node) void {","class":"lineCov","hits":"2","order":"4730","possible_hits":"2",},
{"lineNum":"   29","line":"    std.debug.assert(nd.getType() == NodeType.Alias);","class":"lineCov","hits":"1","order":"4731","possible_hits":"1",},
{"lineNum":"   30","line":""},
{"lineNum":"   31","line":"    const alias = nd.data.Alias;","class":"linePartCov","hits":"2","order":"4732","possible_hits":"3",},
{"lineNum":"   32","line":"    const name = alias.name;","class":"lineCov","hits":"1","order":"4733","possible_hits":"1",},
{"lineNum":"   33","line":"    const ty = cmp.findType(alias.value) orelse {","class":"lineCov","hits":"2","order":"4734","possible_hits":"2",},
...
{"lineNum":"   41","line":"    };"},
{"lineNum":"   42","line":""},
{"lineNum":"   43","line":"    cmp.scope.putType(name, cmp.typebook.getAlias(name, ty));","class":"lineCov","hits":"1","order":"4743","possible_hits":"1",},
{"lineNum":"   44","line":"}"},
{"lineNum":"   45","line":""},
{"lineNum":"   46","line":"test \"can compile a type alias declaration\" {","class":"lineCov","hits":"2","order":"4727","possible_hits":"2",},
{"lineNum":"   47","line":"    try (CompilerTestCase{","class":"lineCov","hits":"1","order":"4752","possible_hits":"1",},
{"lineNum":"   48","line":"        .code = \"type ATypeAlias = number | boolean;\","},
{"lineNum":"   49","line":"    }).run();","class":"lineCov","hits":"1","order":"4728","possible_hits":"1",},
{"lineNum":"   50","line":"}"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "test", "date" : "2022-01-10 07:49:02", "instrumented" : 14, "covered" : 9,};
var merged_data = [];
