...
{"lineNum":"   20","line":""},
{"lineNum":"   21","line":"pub fn memEql(comptime T: type, a: []const T, b: []const T) bool {","class":"linePartCov","hits":"3","order":"838","possible_hits":"10",},
{"lineNum":"   22","line":"    if (a.len != b.len)","class":"linePartCov","hits":"6","order":"839","possible_hits":"20",},
...
{"lineNum":"   56","line":"                const tag_a = activeTag(a);","class":"linePartCov","hits":"2","order":"832","possible_hits":"3",},
{"lineNum":"   57","line":"                const tag_b = activeTag(b);","class":"linePartCov","hits":"2","order":"833","possible_hits":"3",},
...
{"lineNum":"   84","line":"            return switch (info.size) {","class":"linePartCov","hits":"5","order":"842","possible_hits":"12",},
{"lineNum":"   85","line":"                .One, .Many, .C => a == b,","class":"lineCov","hits":"2","order":"846","possible_hits":"2",},
{"lineNum":"   86","line":"                .Slice => memEql(info.child, a, b),","class":"linePartCov","hits":"3","order":"837","possible_hits":"10",},
{"lineNum":"   87","line":"            };"},
{"lineNum":"   88","line":"        },"},
{"lineNum":"   89","line":"        .Optional => {"},
{"lineNum":"   90","line":"            if (a == null and b == null) return true;","class":"linePartCov","hits":"2","order":"843","possible_hits":"4",},
{"lineNum":"   91","line":"            if (a == null or b == null) return false;","class":"linePartCov","hits":"2","order":"844","possible_hits":"4",},
{"lineNum":"   92","line":"            return eql(a.?, b.?);","class":"linePartCov","hits":"2","order":"845","possible_hits":"4",},
{"lineNum":"   93","line":"        },"},
{"lineNum":"   94","line":"        else => return a == b,","class":"linePartCov","hits":"4","order":"830","possible_hits":"7",},
{"lineNum":"   95","line":"    }"},
{"lineNum":"   96","line":"}"},
]};
