...
{"lineNum":"   30","line":"        }"},
{"lineNum":"   31","line":"    }"},
{"lineNum":"   32","line":"    return true;","class":"linePartCov","hits":"3","order":"722","possible_hits":"11",},
{"lineNum":"   33","line":"}"},
{"lineNum":"   34","line":""},
...
{"lineNum":"   37","line":"pub fn eql(a: anytype, b: @TypeOf(a)) bool {","class":"linePartCov","hits":"29","order":"255","possible_hits":"75",},
...
{"lineNum":"   43","line":"                if (!eql(@field(a, field_info.name), @field(b, field_info.name))) return false;","class":"linePartCov","hits":"15","order":"256","possible_hits":"45",},
{"lineNum":"   44","line":"            }"},
{"lineNum":"   45","line":"            return true;","class":"linePartCov","hits":"15","order":"258","possible_hits":"47",},
{"lineNum":"   46","line":"        },"},
...
{"lineNum":"   56","line":"                const tag_a = activeTag(a);","class":"linePartCov","hits":"1","order":"259","possible_hits":"3",},
{"lineNum":"   57","line":"                const tag_b = activeTag(b);","class":"linePartCov","hits":"1","order":"260","possible_hits":"3",},
{"lineNum":"   58","line":"                if (tag_a != tag_b) return false;","class":"linePartCov","hits":"1","order":"261","possible_hits":"3",},
{"lineNum":"   59","line":""},
{"lineNum":"   60","line":"                inline for (info.fields) |field_info| {"},
{"lineNum":"   61","line":"                    if (@field(UnionTag, field_info.name) == tag_a) {","class":"linePartCov","hits":"20","order":"262","possible_hits":"51",},
{"lineNum":"   62","line":"                        return eql(@field(a, field_info.name), @field(b, field_info.name));","class":"linePartCov","hits":"2","order":"263","possible_hits":"51",},
{"lineNum":"   63","line":"                    }"},
{"lineNum":"   64","line":"                }"},
...
var header = { "command" : "test", "date" : "2022-02-13 15:55:52", "instrumented" : 25, "covered" : 22,};
var merged_data = [];
