...
{"lineNum":"   20","line":""},
{"lineNum":"   21","line":"pub fn memEql(comptime T: type, a: []const T, b: []const T) bool {","class":"linePartCov","hits":"3","order":"244","possible_hits":"11",},
...
{"lineNum":"   29","line":"            else => if (b[index] != item) return false,","class":"linePartCov","hits":"3","order":"248","possible_hits":"6",},
{"lineNum":"   30","line":"        }"},
{"lineNum":"   31","line":"    }"},
{"lineNum":"   32","line":"    return true;","class":"linePartCov","hits":"3","order":"249","possible_hits":"11",},
{"lineNum":"   33","line":"}"},
{"lineNum":"   34","line":""},
...
{"lineNum":"   43","line":"                if (!eql(@field(a, field_info.name), @field(b, field_info.name))) return false;","class":"linePartCov","hits":"15","order":"242","possible_hits":"44",},
{"lineNum":"   44","line":"            }"},
{"lineNum":"   45","line":"            return true;","class":"linePartCov","hits":"15","order":"251","possible_hits":"46",},
{"lineNum":"   46","line":"        },"},
...
{"lineNum":"   56","line":"                const tag_a = activeTag(a);","class":"linePartCov","hits":"2","order":"237","possible_hits":"3",},
{"lineNum":"   57","line":"                const tag_b = activeTag(b);","class":"linePartCov","hits":"2","order":"238","possible_hits":"3",},
{"lineNum":"   58","line":"                if (tag_a != tag_b) return false;","class":"linePartCov","hits":"2","order":"239","possible_hits":"3",},
{"lineNum":"   59","line":""},
{"lineNum":"   60","line":"                inline for (info.fields) |field_info| {"},
{"lineNum":"   61","line":"                    if (@field(UnionTag, field_info.name) == tag_a) {","class":"linePartCov","hits":"36","order":"240","possible_hits":"67",},
{"lineNum":"   62","line":"                        return eql(@field(a, field_info.name), @field(b, field_info.name));","class":"linePartCov","hits":"7","order":"241","possible_hits":"67",},
{"lineNum":"   63","line":"                    }"},
{"lineNum":"   64","line":"                }"},
...
var header = { "command" : "test", "date" : "2022-01-24 08:01:28", "instrumented" : 25, "covered" : 22,};
var merged_data = [];
