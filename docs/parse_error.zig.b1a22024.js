...
{"lineNum":"   38","line":""},
{"lineNum":"   39","line":"    pub fn new(data: anytype) ExpectedData {","class":"linePartCov","hits":"3","order":"772","possible_hits":"24",},
{"lineNum":"   40","line":"        return switch (@typeInfo(@TypeOf(data))) {","class":"linePartCov","hits":"3","order":"774","possible_hits":"24",},
{"lineNum":"   41","line":"            .Enum => ExpectedData{ .Token = data },","class":"lineCov","hits":"1","order":"773","possible_hits":"1",},
...
{"lineNum":"   81","line":""},
{"lineNum":"   82","line":"    pub fn new(data: anytype) FoundData {","class":"lineCov","hits":"2","order":"776","possible_hits":"2",},
{"lineNum":"   83","line":"        return switch (@typeInfo(@TypeOf(data))) {","class":"lineCov","hits":"2","order":"778","possible_hits":"2",},
{"lineNum":"   84","line":"            .Struct => FoundData{ .Token = data },","class":"lineCov","hits":"1","order":"2286","possible_hits":"1",},
{"lineNum":"   85","line":"            .Pointer => FoundData{ .Node = data },","class":"lineCov","hits":"1","order":"777","possible_hits":"1",},
{"lineNum":"   86","line":"            else => @compileError(\"found must be a Token or a Node\"),"},
{"lineNum":"   87","line":"        };"},
{"lineNum":"   88","line":"    }"},
{"lineNum":"   89","line":""},
{"lineNum":"   90","line":"    pub fn getCursor(self: FoundData) Cursor {","class":"lineCov","hits":"1","order":"783","possible_hits":"1",},
{"lineNum":"   91","line":"        return switch (self) {","class":"linePartCov","hits":"3","order":"784","possible_hits":"4",},
{"lineNum":"   92","line":"            .Token => self.Token.csr,","class":"linePartCov","hits":"2","order":"2305","possible_hits":"3",},
{"lineNum":"   93","line":"            .Node => self.Node.csr,","class":"linePartCov","hits":"2","order":"785","possible_hits":"3",},
{"lineNum":"   94","line":"        };"},
{"lineNum":"   95","line":"    }"},
{"lineNum":"   96","line":""},
...
{"lineNum":"  132","line":""},
{"lineNum":"  133","line":"    pub fn new(expectedData: anytype, foundData: anytype) Expected {","class":"linePartCov","hits":"3","order":"770","possible_hits":"24",},
{"lineNum":"  134","line":"        return Expected{","class":"linePartCov","hits":"3","order":"779","possible_hits":"24",},
{"lineNum":"  135","line":"            .expected = ExpectedData.new(expectedData),","class":"linePartCov","hits":"3","order":"771","possible_hits":"24",},
{"lineNum":"  136","line":"            .found = FoundData.new(foundData),","class":"linePartCov","hits":"3","order":"775","possible_hits":"24",},
{"lineNum":"  137","line":"        };"},
{"lineNum":"  138","line":"    }"},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"    pub fn getCursor(self: Expected) Cursor {","class":"lineCov","hits":"1","order":"781","possible_hits":"1",},
{"lineNum":"  141","line":"        return self.found.getCursor();","class":"lineCov","hits":"1","order":"782","possible_hits":"1",},
{"lineNum":"  142","line":"    }"},
{"lineNum":"  143","line":""},
...
{"lineNum":"  175","line":"    }"},
{"lineNum":"  176","line":""},
{"lineNum":"  177","line":"    pub fn getType(self: ParseErrorData) Type {","class":"lineCov","hits":"1","order":"806","possible_hits":"1",},
{"lineNum":"  178","line":"        return @as(Type, self);","class":"lineCov","hits":"1","order":"807","possible_hits":"1",},
{"lineNum":"  179","line":"    }"},
{"lineNum":"  180","line":"};"},
{"lineNum":"  181","line":""},
...
{"lineNum":"  187","line":""},
{"lineNum":"  188","line":"    pub fn expected(expectedData: anytype, foundData: anytype) ParseError {","class":"linePartCov","hits":"3","order":"768","possible_hits":"24",},
{"lineNum":"  189","line":"        const exp = Expected.new(expectedData, foundData);","class":"linePartCov","hits":"3","order":"769","possible_hits":"24",},
{"lineNum":"  190","line":"        return ParseError{","class":"linePartCov","hits":"3","order":"788","possible_hits":"24",},
{"lineNum":"  191","line":"            .csr = exp.getCursor(),","class":"linePartCov","hits":"3","order":"780","possible_hits":"24",},
{"lineNum":"  192","line":"            .data = ParseErrorData{","class":"linePartCov","hits":"3","order":"786","possible_hits":"24",},
{"lineNum":"  193","line":"                .Expected = exp,","class":"linePartCov","hits":"3","order":"787","possible_hits":"24",},
{"lineNum":"  194","line":"            },"},
{"lineNum":"  195","line":"        };"},
{"lineNum":"  196","line":"    }"},
{"lineNum":"  197","line":""},
...
var header = { "command" : "test", "date" : "2022-02-01 20:02:57", "instrumented" : 101, "covered" : 87,};
var merged_data = [];
