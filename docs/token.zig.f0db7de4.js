...
{"lineNum":"  176","line":"};"},
{"lineNum":"  177","line":""},
{"lineNum":"  178","line":"test \"token can be initialized with no data\" {","class":"lineCov","hits":"2","order":"633","possible_hits":"2",},
{"lineNum":"  179","line":"    const ty: Token.Type = .Int;"},
{"lineNum":"  180","line":"    const ln: u32 = 3;"},
{"lineNum":"  181","line":"    const ch: u32 = 4;"},
{"lineNum":"  182","line":"    const csr = Cursor.new(ln, ch);","class":"lineCov","hits":"1","order":"634","possible_hits":"1",},
{"lineNum":"  183","line":"    const expectedData: []const u8 = \"\";"},
{"lineNum":"  184","line":""},
{"lineNum":"  185","line":"    const token = Token.new(ty, csr);","class":"lineCov","hits":"1","order":"635","possible_hits":"1",},
{"lineNum":"  186","line":""},
{"lineNum":"  187","line":"    try expectEqual(ty, token.ty);","class":"lineCov","hits":"1","order":"636","possible_hits":"1",},
{"lineNum":"  188","line":"    try expectEqual(ln, token.csr.ln);","class":"lineCov","hits":"1","order":"637","possible_hits":"1",},
{"lineNum":"  189","line":"    try expectEqual(ch, token.csr.ch);","class":"lineCov","hits":"1","order":"638","possible_hits":"1",},
{"lineNum":"  190","line":"    try expectEqual(expectedData, token.data);","class":"lineCov","hits":"1","order":"639","possible_hits":"1",},
{"lineNum":"  191","line":"}"},
{"lineNum":"  192","line":""},
{"lineNum":"  193","line":"test \"token can be initialized with data\" {","class":"lineCov","hits":"2","order":"640","possible_hits":"2",},
{"lineNum":"  194","line":"    const ty: Token.Type = .Int;"},
{"lineNum":"  195","line":"    const ln: u32 = 3;"},
{"lineNum":"  196","line":"    const ch: u32 = 4;"},
{"lineNum":"  197","line":"    const csr = Cursor.new(ln, ch);","class":"lineCov","hits":"1","order":"641","possible_hits":"1",},
{"lineNum":"  198","line":"    const data: []const u8 = \"Some sample data\";"},
{"lineNum":"  199","line":""},
{"lineNum":"  200","line":"    const token = Token.newData(ty, csr, data);","class":"lineCov","hits":"1","order":"642","possible_hits":"1",},
{"lineNum":"  201","line":""},
{"lineNum":"  202","line":"    try expectEqual(ty, token.ty);","class":"lineCov","hits":"1","order":"643","possible_hits":"1",},
{"lineNum":"  203","line":"    try expectEqual(csr.ln, token.csr.ln);","class":"lineCov","hits":"1","order":"644","possible_hits":"1",},
{"lineNum":"  204","line":"    try expectEqual(csr.ch, token.csr.ch);","class":"lineCov","hits":"1","order":"645","possible_hits":"1",},
{"lineNum":"  205","line":"    try expectEqual(data, token.data);","class":"lineCov","hits":"1","order":"646","possible_hits":"1",},
{"lineNum":"  206","line":"}"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "test", "date" : "2022-01-05 21:30:20", "instrumented" : 26, "covered" : 26,};
var merged_data = [];
