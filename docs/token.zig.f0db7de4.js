...
{"lineNum":"  177","line":"};"},
{"lineNum":"  178","line":""},
{"lineNum":"  179","line":"test \"token can be initialized with no data\" {","class":"lineCov","hits":"2","order":"693","possible_hits":"2",},
{"lineNum":"  180","line":"    const ty: Token.Type = .Int;"},
{"lineNum":"  181","line":"    const ln: u32 = 3;"},
{"lineNum":"  182","line":"    const ch: u32 = 4;"},
{"lineNum":"  183","line":"    const csr = Cursor.new(ln, ch);","class":"lineCov","hits":"1","order":"694","possible_hits":"1",},
{"lineNum":"  184","line":"    const expectedData: []const u8 = \"\";"},
{"lineNum":"  185","line":""},
{"lineNum":"  186","line":"    const token = Token.new(ty, csr);","class":"lineCov","hits":"1","order":"695","possible_hits":"1",},
{"lineNum":"  187","line":""},
{"lineNum":"  188","line":"    try expectEqual(ty, token.ty);","class":"lineCov","hits":"1","order":"696","possible_hits":"1",},
{"lineNum":"  189","line":"    try expectEqual(ln, token.csr.ln);","class":"lineCov","hits":"1","order":"697","possible_hits":"1",},
{"lineNum":"  190","line":"    try expectEqual(ch, token.csr.ch);","class":"lineCov","hits":"1","order":"698","possible_hits":"1",},
{"lineNum":"  191","line":"    try expectEqual(expectedData, token.data);","class":"lineCov","hits":"1","order":"699","possible_hits":"1",},
{"lineNum":"  192","line":"}"},
{"lineNum":"  193","line":""},
{"lineNum":"  194","line":"test \"token can be initialized with data\" {","class":"lineCov","hits":"2","order":"700","possible_hits":"2",},
{"lineNum":"  195","line":"    const ty: Token.Type = .Int;"},
{"lineNum":"  196","line":"    const ln: u32 = 3;"},
{"lineNum":"  197","line":"    const ch: u32 = 4;"},
{"lineNum":"  198","line":"    const csr = Cursor.new(ln, ch);","class":"lineCov","hits":"1","order":"701","possible_hits":"1",},
{"lineNum":"  199","line":"    const data: []const u8 = \"Some sample data\";"},
{"lineNum":"  200","line":""},
{"lineNum":"  201","line":"    const token = Token.newData(ty, csr, data);","class":"lineCov","hits":"1","order":"702","possible_hits":"1",},
{"lineNum":"  202","line":""},
{"lineNum":"  203","line":"    try expectEqual(ty, token.ty);","class":"lineCov","hits":"1","order":"703","possible_hits":"1",},
{"lineNum":"  204","line":"    try expectEqual(csr.ln, token.csr.ln);","class":"lineCov","hits":"1","order":"704","possible_hits":"1",},
{"lineNum":"  205","line":"    try expectEqual(csr.ch, token.csr.ch);","class":"lineCov","hits":"1","order":"705","possible_hits":"1",},
{"lineNum":"  206","line":"    try expectEqual(data, token.data);","class":"lineCov","hits":"1","order":"706","possible_hits":"1",},
{"lineNum":"  207","line":"}"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "test", "date" : "2022-01-13 08:50:59", "instrumented" : 26, "covered" : 26,};
var merged_data = [];
