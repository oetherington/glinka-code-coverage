...
{"lineNum":"  178","line":"};"},
{"lineNum":"  179","line":""},
{"lineNum":"  180","line":"test \"token can be initialized with no data\" {","class":"lineCov","hits":"2","order":"718","possible_hits":"2",},
{"lineNum":"  181","line":"    const ty: Token.Type = .Int;"},
{"lineNum":"  182","line":"    const ln: u32 = 3;"},
{"lineNum":"  183","line":"    const ch: u32 = 4;"},
{"lineNum":"  184","line":"    const csr = Cursor.new(ln, ch);","class":"lineCov","hits":"1","order":"719","possible_hits":"1",},
{"lineNum":"  185","line":"    const expectedData: []const u8 = \"\";"},
{"lineNum":"  186","line":""},
{"lineNum":"  187","line":"    const token = Token.new(ty, csr);","class":"lineCov","hits":"1","order":"720","possible_hits":"1",},
{"lineNum":"  188","line":""},
{"lineNum":"  189","line":"    try expectEqual(ty, token.ty);","class":"lineCov","hits":"1","order":"721","possible_hits":"1",},
{"lineNum":"  190","line":"    try expectEqual(ln, token.csr.ln);","class":"lineCov","hits":"1","order":"722","possible_hits":"1",},
{"lineNum":"  191","line":"    try expectEqual(ch, token.csr.ch);","class":"lineCov","hits":"1","order":"723","possible_hits":"1",},
{"lineNum":"  192","line":"    try expectEqual(expectedData, token.data);","class":"lineCov","hits":"1","order":"724","possible_hits":"1",},
{"lineNum":"  193","line":"}"},
{"lineNum":"  194","line":""},
{"lineNum":"  195","line":"test \"token can be initialized with data\" {","class":"lineCov","hits":"2","order":"725","possible_hits":"2",},
{"lineNum":"  196","line":"    const ty: Token.Type = .Int;"},
{"lineNum":"  197","line":"    const ln: u32 = 3;"},
{"lineNum":"  198","line":"    const ch: u32 = 4;"},
{"lineNum":"  199","line":"    const csr = Cursor.new(ln, ch);","class":"lineCov","hits":"1","order":"726","possible_hits":"1",},
{"lineNum":"  200","line":"    const data: []const u8 = \"Some sample data\";"},
{"lineNum":"  201","line":""},
{"lineNum":"  202","line":"    const token = Token.newData(ty, csr, data);","class":"lineCov","hits":"1","order":"727","possible_hits":"1",},
{"lineNum":"  203","line":""},
{"lineNum":"  204","line":"    try expectEqual(ty, token.ty);","class":"lineCov","hits":"1","order":"728","possible_hits":"1",},
{"lineNum":"  205","line":"    try expectEqual(csr.ln, token.csr.ln);","class":"lineCov","hits":"1","order":"729","possible_hits":"1",},
{"lineNum":"  206","line":"    try expectEqual(csr.ch, token.csr.ch);","class":"lineCov","hits":"1","order":"730","possible_hits":"1",},
{"lineNum":"  207","line":"    try expectEqual(data, token.data);","class":"lineCov","hits":"1","order":"731","possible_hits":"1",},
{"lineNum":"  208","line":"}"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "test", "date" : "2022-01-19 08:42:21", "instrumented" : 26, "covered" : 26,};
var merged_data = [];
