...
{"lineNum":"   42","line":"    }"},
{"lineNum":"   43","line":""},
{"lineNum":"   44","line":"    pub fn parseType(self: *Parser) ParseResult {","class":"lineCov","hits":"1","order":"2411","possible_hits":"1",},
{"lineNum":"   45","line":"        return self.callbacks.parseType(self);","class":"lineCov","hits":"1","order":"2412","possible_hits":"1",},
{"lineNum":"   46","line":"    }"},
{"lineNum":"   47","line":""},
...
{"lineNum":"   50","line":"    }"},
{"lineNum":"   51","line":""},
{"lineNum":"   52","line":"    pub fn parseStmt(self: *Parser) ParseResult {","class":"lineCov","hits":"1","order":"1792","possible_hits":"1",},
{"lineNum":"   53","line":"        return self.callbacks.parseStmt(self);","class":"lineCov","hits":"1","order":"1793","possible_hits":"1",},
{"lineNum":"   54","line":"    }"},
{"lineNum":"   55","line":""},
{"lineNum":"   56","line":"    pub fn next(self: *Parser) ParseResult {","class":"lineCov","hits":"1","order":"1790","possible_hits":"1",},
{"lineNum":"   57","line":"        return self.parseStmt();","class":"lineCov","hits":"1","order":"1791","possible_hits":"1",},
{"lineNum":"   58","line":"    }"},
{"lineNum":"   59","line":""},
{"lineNum":"   60","line":"    pub fn getAst(self: *Parser, arena: *Arena) ParseResult {","class":"lineCov","hits":"1","order":"3188","possible_hits":"1",},
{"lineNum":"   61","line":"        var alloc = arena.allocator();","class":"lineCov","hits":"1","order":"3189","possible_hits":"1",},
{"lineNum":"   62","line":""},
{"lineNum":"   63","line":"        var nd = node.makeNode(","class":"lineCov","hits":"1","order":"3191","possible_hits":"1",},
{"lineNum":"   64","line":"            alloc,"},
{"lineNum":"   65","line":"            Cursor.new(1, 1),","class":"lineCov","hits":"1","order":"3190","possible_hits":"1",},
{"lineNum":"   66","line":"            .Program,"},
{"lineNum":"   67","line":"            node.NodeList{},"},
{"lineNum":"   68","line":"        );"},
{"lineNum":"   69","line":""},
{"lineNum":"   70","line":"        while (true) {","class":"lineCov","hits":"2","order":"3192","possible_hits":"2",},
{"lineNum":"   71","line":"            const res = self.next();","class":"lineCov","hits":"1","order":"3193","possible_hits":"1",},
{"lineNum":"   72","line":""},
{"lineNum":"   73","line":"            switch (res) {","class":"linePartCov","hits":"1","order":"3194","possible_hits":"2",},
{"lineNum":"   74","line":"                .Success => |node| {","class":"lineCov","hits":"1","order":"3195","possible_hits":"1",},
{"lineNum":"   75","line":"                    switch (node.getType()) {","class":"lineCov","hits":"2","order":"3196","possible_hits":"2",},
{"lineNum":"   76","line":"                        .EOF => return ParseResult.success(nd),","class":"lineCov","hits":"1","order":"3200","possible_hits":"1",},
{"lineNum":"   77","line":"                        else => nd.data.Program.append(","class":"linePartCov","hits":"2","order":"3197","possible_hits":"3",},
{"lineNum":"   78","line":"                            alloc,"},
{"lineNum":"   79","line":"                            node,","class":"lineCov","hits":"1","order":"3198","possible_hits":"1",},
{"lineNum":"   80","line":"                        ) catch allocate.reportAndExit(),","class":"linePartCov","hits":"2","order":"3199","possible_hits":"3",},
{"lineNum":"   81","line":"                    }"},
{"lineNum":"   82","line":"                },"},
...
var header = { "command" : "test", "date" : "2021-12-30 19:23:58", "instrumented" : 28, "covered" : 19,};
var merged_data = [];
