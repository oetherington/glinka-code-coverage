...
{"lineNum":"   28","line":""},
{"lineNum":"   29","line":"    pub fn new(csr: Cursor, msg: []const u8) GenericError {","class":"lineCov","hits":"1","order":"2359","possible_hits":"1",},
{"lineNum":"   30","line":"        return GenericError{","class":"lineCov","hits":"1","order":"2362","possible_hits":"1",},
{"lineNum":"   31","line":"            .csr = csr,","class":"lineCov","hits":"1","order":"2360","possible_hits":"1",},
{"lineNum":"   32","line":"            .msg = msg,","class":"lineCov","hits":"1","order":"2361","possible_hits":"1",},
{"lineNum":"   33","line":"        };"},
{"lineNum":"   34","line":"    }"},
{"lineNum":"   35","line":""},
...
{"lineNum":"   46","line":"};"},
{"lineNum":"   47","line":""},
{"lineNum":"   48","line":"test \"can initialize and report a GenericError\" {","class":"lineCov","hits":"2","order":"2492","possible_hits":"2",},
{"lineNum":"   49","line":"    const csr = Cursor.new(2, 5);","class":"lineCov","hits":"1","order":"2493","possible_hits":"1",},
{"lineNum":"   50","line":"    const msg = \"Some error message\";"},
{"lineNum":"   51","line":"    const err = GenericError.new(csr, msg);","class":"lineCov","hits":"1","order":"2494","possible_hits":"1",},
{"lineNum":"   52","line":"    try expectEqual(csr, err.csr);","class":"lineCov","hits":"1","order":"2495","possible_hits":"1",},
{"lineNum":"   53","line":"    try expectEqualStrings(msg, err.msg);","class":"lineCov","hits":"1","order":"2496","possible_hits":"1",},
{"lineNum":"   54","line":"}"},
]};
