...
{"lineNum":"   54","line":"    }"},
{"lineNum":"   55","line":""},
{"lineNum":"   56","line":"    pub fn dump(","class":"linePartCov","hits":"1","order":"752","possible_hits":"2",},
{"lineNum":"   57","line":"        self: Switch,"},
{"lineNum":"   58","line":"        writer: anytype,"},
{"lineNum":"   59","line":"        indent: usize,"},
{"lineNum":"   60","line":"    ) !void {","class":"linePartCov","hits":"1","order":"764","possible_hits":"2",},
{"lineNum":"   61","line":"        try putInd(writer, indent, \"Switch:\\n\", .{});","class":"linePartCov","hits":"1","order":"753","possible_hits":"2",},
{"lineNum":"   62","line":"        try self.expr.dumpIndented(writer, indent + 2);","class":"linePartCov","hits":"1","order":"754","possible_hits":"4",},
{"lineNum":"   63","line":""},
{"lineNum":"   64","line":"        for (self.cases.items) |item| {","class":"linePartCov","hits":"2","order":"755","possible_hits":"4",},
{"lineNum":"   65","line":"            try putInd(writer, indent + 2, \"Case:\\n\", .{});","class":"linePartCov","hits":"1","order":"756","possible_hits":"4",},
{"lineNum":"   66","line":"            try item.value.dumpIndented(writer, indent + 4);","class":"linePartCov","hits":"1","order":"757","possible_hits":"4",},
{"lineNum":"   67","line":"            for (item.stmts.items) |stmt|","class":"linePartCov","hits":"2","order":"758","possible_hits":"4",},
{"lineNum":"   68","line":"                try stmt.dumpIndented(writer, indent + 4);","class":"linePartCov","hits":"1","order":"759","possible_hits":"4",},
{"lineNum":"   69","line":"        }"},
{"lineNum":"   70","line":""},
{"lineNum":"   71","line":"        if (self.default) |default| {","class":"linePartCov","hits":"2","order":"760","possible_hits":"4",},
{"lineNum":"   72","line":"            try putInd(writer, indent + 2, \"Default:\\n\", .{});","class":"linePartCov","hits":"1","order":"761","possible_hits":"4",},
{"lineNum":"   73","line":"            for (default.items) |stmt|","class":"linePartCov","hits":"2","order":"762","possible_hits":"4",},
{"lineNum":"   74","line":"                try stmt.dumpIndented(writer, indent + 4);","class":"linePartCov","hits":"1","order":"763","possible_hits":"4",},
{"lineNum":"   75","line":"        }"},
{"lineNum":"   76","line":"    }"},
{"lineNum":"   77","line":"};"},
{"lineNum":"   78","line":""},
...
var header = { "command" : "test", "date" : "2022-02-09 08:39:20", "instrumented" : 59, "covered" : 59,};
var merged_data = [];
