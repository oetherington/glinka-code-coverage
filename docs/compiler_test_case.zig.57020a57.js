...
{"lineNum":"   47","line":"    }"},
{"lineNum":"   48","line":""},
{"lineNum":"   49","line":"    fn nopCallback(be: *Backend) Backend.Error!void {","class":"lineCov","hits":"2","order":"3018","possible_hits":"2",},
{"lineNum":"   50","line":"        _ = be;"},
{"lineNum":"   51","line":"    }"},
{"lineNum":"   52","line":""},
{"lineNum":"   53","line":"    fn nopNodeCallback(be: *Backend, nd: Node) Backend.Error!void {","class":"lineCov","hits":"2","order":"3084","possible_hits":"2",},
...
{"lineNum":"   68","line":""},
{"lineNum":"   69","line":"    pub fn run(comptime self: @This()) !void {","class":"lineCov","hits":"174","order":"2909","possible_hits":"174",},
{"lineNum":"   70","line":"        var arena = Arena.init(std.testing.allocator);","class":"lineCov","hits":"58","order":"2910","possible_hits":"58",},
{"lineNum":"   71","line":"        defer arena.deinit();","class":"linePartCov","hits":"58","order":"3092","possible_hits":"349",},
{"lineNum":"   72","line":""},
{"lineNum":"   73","line":"        var tsParser = TsParser.new(&arena, self.code);","class":"lineCov","hits":"58","order":"2911","possible_hits":"58",},
{"lineNum":"   74","line":""},
{"lineNum":"   75","line":"        var parser = tsParser.getParser();","class":"lineCov","hits":"58","order":"2912","possible_hits":"58",},
{"lineNum":"   76","line":""},
{"lineNum":"   77","line":"        const res = parser.getAst(&arena);","class":"lineCov","hits":"58","order":"2915","possible_hits":"58",},
{"lineNum":"   78","line":"        try res.reportIfError(std.io.getStdErr().writer());","class":"linePartCov","hits":"58","order":"3002","possible_hits":"116",},
{"lineNum":"   79","line":"        try self.expect(res.isSuccess());","class":"linePartCov","hits":"58","order":"3005","possible_hits":"116",},
{"lineNum":"   80","line":"        try self.expectEqual(NodeType.Program, res.Success.getType());","class":"linePartCov","hits":"116","order":"3008","possible_hits":"174",},
{"lineNum":"   81","line":""},
{"lineNum":"   82","line":"        const config = Config{};"},
{"lineNum":"   83","line":""},
{"lineNum":"   84","line":"        var backend = NopBackend.new();","class":"lineCov","hits":"58","order":"3012","possible_hits":"58",},
{"lineNum":"   85","line":""},
...
{"lineNum":"   89","line":"            &backend.backend,","class":"lineCov","hits":"1","order":"4986","possible_hits":"1",},
{"lineNum":"   90","line":"        );"},
...
{"lineNum":"   94","line":"            try setup(compiler);","class":"linePartCov","hits":"1","order":"4987","possible_hits":"2",},
{"lineNum":"   95","line":""},
{"lineNum":"   96","line":"        try compiler.compileProgramNode(res.Success);","class":"linePartCov","hits":"116","order":"3014","possible_hits":"174",},
{"lineNum":"   97","line":""},
{"lineNum":"   98","line":"        try self.check(self, compiler);","class":"linePartCov","hits":"58","order":"3086","possible_hits":"116",},
{"lineNum":"   99","line":"    }"},
{"lineNum":"  100","line":""},
{"lineNum":"  101","line":"    pub fn expect(self: CompilerTestCase, ok: bool) Error!void {","class":"lineCov","hits":"2","order":"3006","possible_hits":"2",},
{"lineNum":"  102","line":"        _ = self;"},
{"lineNum":"  103","line":"        try std.testing.expect(ok);","class":"lineCov","hits":"1","order":"3007","possible_hits":"1",},
{"lineNum":"  104","line":"    }"},
{"lineNum":"  105","line":""},
{"lineNum":"  106","line":"    pub fn expectEqual(","class":"lineCov","hits":"7","order":"3009","possible_hits":"7",},
{"lineNum":"  107","line":"        self: CompilerTestCase,"},
{"lineNum":"  108","line":"        expected: anytype,"},
{"lineNum":"  109","line":"        actual: @TypeOf(expected),"},
{"lineNum":"  110","line":"    ) Error!void {","class":"lineCov","hits":"7","order":"3011","possible_hits":"7",},
...
{"lineNum":"  113","line":"    }"},
{"lineNum":"  114","line":""},
{"lineNum":"  115","line":"    pub fn expectEqualStrings(","class":"lineCov","hits":"1","order":"3418","possible_hits":"1",},
{"lineNum":"  116","line":"        self: CompilerTestCase,"},
{"lineNum":"  117","line":"        expected: []const u8,"},
{"lineNum":"  118","line":"        actual: []const u8,"},
{"lineNum":"  119","line":"    ) Error!void {","class":"lineCov","hits":"1","order":"3420","possible_hits":"1",},
{"lineNum":"  120","line":"        _ = self;"},
{"lineNum":"  121","line":"        try std.testing.expectEqualStrings(expected, actual);","class":"lineCov","hits":"1","order":"3419","possible_hits":"1",},
{"lineNum":"  122","line":"    }"},
{"lineNum":"  123","line":""},
...
{"lineNum":"  125","line":"        const hasErrors = cmp.hasErrors();","class":"lineCov","hits":"1","order":"3088","possible_hits":"1",},
{"lineNum":"  126","line":"        if (hasErrors)","class":"linePartCov","hits":"1","order":"3089","possible_hits":"2",},
{"lineNum":"  127","line":"            try cmp.reportErrors();","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"  128","line":"        try self.expect(!hasErrors);","class":"lineCov","hits":"1","order":"3090","possible_hits":"1",},
{"lineNum":"  129","line":"    }"},
{"lineNum":"  130","line":"};"},
]};
var percent_low = 25;var percent_high = 75;
var header = { "command" : "test", "date" : "2022-01-27 20:25:15", "instrumented" : 37, "covered" : 36,};
var merged_data = [];
