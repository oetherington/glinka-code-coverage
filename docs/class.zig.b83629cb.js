...
{"lineNum":"   47","line":""},
{"lineNum":"   48","line":"        pub fn getType(self: Data) Variant {","class":"lineCov","hits":"1","order":"4931","possible_hits":"1",},
{"lineNum":"   49","line":"            return @as(Variant, self);","class":"lineCov","hits":"1","order":"4932","possible_hits":"1",},
{"lineNum":"   50","line":"        }"},
{"lineNum":"   51","line":"    };"},
{"lineNum":"   52","line":""},
...
{"lineNum":"   56","line":""},
{"lineNum":"   57","line":"    pub fn getType(self: ClassTypeMember) Variant {","class":"lineCov","hits":"1","order":"4929","possible_hits":"1",},
{"lineNum":"   58","line":"        return self.data.getType();","class":"lineCov","hits":"1","order":"4930","possible_hits":"1",},
{"lineNum":"   59","line":"    }"},
{"lineNum":"   60","line":""},
{"lineNum":"   61","line":"    pub fn dump(self: ClassTypeMember, writer: anytype, indent: usize) !void {","class":"linePartCov","hits":"2","order":"538","possible_hits":"4",},
{"lineNum":"   62","line":"        try putInd(writer, indent, \"ClassTypeMember (\", .{});","class":"linePartCov","hits":"1","order":"539","possible_hits":"2",},
{"lineNum":"   63","line":"        if (self.isStatic)","class":"linePartCov","hits":"2","order":"540","possible_hits":"4",},
{"lineNum":"   64","line":"            try writer.print(\"Static \", .{});","class":"linePartCov","hits":"1","order":"541","possible_hits":"2",},
{"lineNum":"   65","line":"        try writer.print(\"{s})\\n\", .{@tagName(self.visibility)});","class":"linePartCov","hits":"1","order":"542","possible_hits":"2",},
{"lineNum":"   66","line":""},
{"lineNum":"   67","line":"        switch (self.data) {","class":"linePartCov","hits":"1","order":"543","possible_hits":"4",},
{"lineNum":"   68","line":"            .Var => |v| {","class":"linePartCov","hits":"1","order":"544","possible_hits":"2",},
{"lineNum":"   69","line":"                try putInd(writer, indent + 2, \"\'{s}\\n\", .{v.name});","class":"linePartCov","hits":"1","order":"545","possible_hits":"4",},
{"lineNum":"   70","line":"                if (v.isReadOnly)","class":"linePartCov","hits":"2","order":"546","possible_hits":"4",},
{"lineNum":"   71","line":"                    try putInd(writer, indent + 2, \"ReadOnly\\n\", .{});","class":"linePartCov","hits":"1","order":"547","possible_hits":"4",},
{"lineNum":"   72","line":"                if (v.ty) |ty|","class":"linePartCov","hits":"2","order":"548","possible_hits":"4",},
{"lineNum":"   73","line":"                    try ty.dumpIndented(writer, indent + 2);","class":"linePartCov","hits":"1","order":"549","possible_hits":"4",},
{"lineNum":"   74","line":"                if (v.value) |value|","class":"linePartCov","hits":"2","order":"550","possible_hits":"4",},
{"lineNum":"   75","line":"                    try value.dumpIndented(writer, indent + 2);","class":"linePartCov","hits":"1","order":"551","possible_hits":"4",},
{"lineNum":"   76","line":"            },"},
{"lineNum":"   77","line":"            .Func => |func| try func.dump(writer, indent + 2),","class":"lineNoCov","hits":"0","possible_hits":"4",},
{"lineNum":"   78","line":"        }"},
{"lineNum":"   79","line":"    }"},
{"lineNum":"   80","line":"};"},
{"lineNum":"   81","line":""},
...
{"lineNum":"  138","line":"    }"},
{"lineNum":"  139","line":""},
{"lineNum":"  140","line":"    pub fn dump(self: ClassType, writer: anytype, indent: usize) !void {","class":"linePartCov","hits":"2","order":"565","possible_hits":"4",},
{"lineNum":"  141","line":"        try putInd(writer, indent, \"ClassType \'{s}\'\\n\", .{self.name});","class":"linePartCov","hits":"1","order":"566","possible_hits":"2",},
{"lineNum":"  142","line":"        if (self.extends) |extends|","class":"linePartCov","hits":"2","order":"567","possible_hits":"4",},
{"lineNum":"  143","line":"            try putInd(writer, indent + 2, \"Extends \'{s}\'\\n\", .{extends});","class":"linePartCov","hits":"1","order":"568","possible_hits":"4",},
{"lineNum":"  144","line":"    }"},
{"lineNum":"  145","line":"};"},
{"lineNum":"  146","line":""},
...
var header = { "command" : "test", "date" : "2022-02-09 08:39:20", "instrumented" : 50, "covered" : 49,};
var merged_data = [];
